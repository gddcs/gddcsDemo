...
public class CircleProgressBar extends View {
    ...
    protected void onDraw(Canvas canvas) {
        ...
        canvas.drawText(mDescription, mWheelRect.centerX() -
                (mTargetPaint.measureText(mDescription) / 2), mTargetY, mTargetPaint);
        canvas.drawText(mTitle, mWheelRect.centerX() -
                (mTitlePaint.measureText(mTitle) / 2), mTitleY, mTitlePaint);
        SweepGradient sweepGradient = new SweepGradient(mWheelRect.centerX(), mWheelRect.centerY(),
                new int[]{
                        ...
                        getResources().getColor(R.color.burlywood)}, null);
    ...
    protected void onMeasure(int widthMeasureSpec, int heightMeasureSpec) {
        ...
        mCircleStrokeWidth = getTextScale(29, min);// 圆弧的宽度
        pressExtraStrokeWidth = getTextScale(52, min);// 圆弧离矩形的距离
